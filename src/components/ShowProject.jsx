...
import { FaTimes, FaReact, FaNode, FaCss3, FaAws, FaHardHat, FaPython, FaEthereum } from 'react-icons/fa'
import { SiTypescript, SiTailwindcss, SiSolidity, SiIpfs, SiOpenzeppelin } from 'react-icons/si'
...
export const ShowProject = () => {
    ...
    return (
        <div className='show-project-container' style={{ '--showModal': showModal }}>
                    ...
                    <div className='show-project-box2'>
                        ...
                        <div className='show-project-box2-identicon-container'>
                            ...
                            <div className="show-project-box2-identicon-owner">
                                <small className='show-project-box2-identicon-owner-title'>@owner</small>
