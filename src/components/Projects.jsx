...
export const Projects = () => {
  ...
  const blockchain = [
    {
      ...
      description: "Marketplace de NFTs foi desenvolvido para oferecer uma experiência excepcional de mintagem, compra e venda de NFTs. Criado com uma visão de inovação e acessibilidade, esse Marketplace NFT é um espaço vibrante onde criadores e colecionadores se encontram para celebrar a arte digital e a criatividade. Com recursos intuitivos e uma interface de usuário amigável, é uma plataforma robusta e confiável para você explorar e interagir com o emocionante mundo dos NFTs.",
      imgUrl: image.projImg10,
      techStack: ["NextJs", "Tailwindcss", "Solidity", "Ipfs", "Openzeppelin", "Truffle", "Ganache"]
    },
    {
      title: "NFT Marketplace",
      subTitle: "Design & Development",
      description: "Desenvolvi um Marketplace de NFTs que vai além das expectativas, proporcionando uma experiência única para mintagem, compra e venda de NFTs. Esse Marketplace NFT é a essência da inovação, oferecendo uma plataforma dinâmica e envolvente para criadores e entusiastas de arte digital.",
      imgUrl: image.projImg11,
      techStack: ["React", "Css", "Solidity", "HardHat", "Ipfs", "Openzeppelin", "Ethereum"]
    },
    {
      title: "Site WEb3",
      subTitle: "Design & Development",
      description: "Meu website pessoal evoluiu para um espaço inovador na web, agora impulsionado pela tecnologia Web3. A cada projeto que realizo, crio um NFT exclusivo, armazenando todas as informações essenciais na blockchain. Cada NFT contém a imagem, título, descrição e tecnologias utilizadas em cada projeto. Em outras palavras, todas as informações relevantes estão seguramente registradas na blockchain, garantindo transparência e autenticidade em cada trabalho apresentado.",
      imgUrl: image.projImg12,
      techStack: ["React", "Css", "NodeJs", "Solidity", "Ipfs", "Openzeppelin", "Ethereum"]
    },
  ];
  ...
  const frontEnd = [

    {
      ...
      description: "Desenvolvi esta landing page com total foco na responsividade, garantindo uma experiência excepcional em qualquer dispositivo. Cada pixel e elemento foi cuidadosamente ajustado para se adaptar perfeitamente a telas de todos os tamanhos, desde smartphones até desktops.",
    ...
    },
    {
      ...
      subTitle: "Development",
      description: "Essa LP foi desenvolvida com uma abordagem centrada na responsividade. Cada detalhe foi meticulosamente projetado para se ajustar perfeitamente a qualquer dispositivo, proporcionando uma experiência consistente e envolvente em todas as telas. ",
  ...
  return (
    <section className="project" id="projects">
            ...
            <TrackVisibility>
              {({ isVisible }) =>
                <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                  ...
                  <Tab.Container id="projects-tabs" defaultActiveKey="blockchain">
      ...
      <img className="background-image-right" src={image.colorSharp2} alt="ColorShap"></img>
    </section>
  )
}
